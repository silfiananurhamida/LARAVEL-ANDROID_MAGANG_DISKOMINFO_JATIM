...
class GuzzleController extends Controller
{
  ...
  public function booking(Request $request){
        ...
        if(!$json['error']){
          ...
          if($json['msg'] == 'Unvalid'){
            return redirect('bookings/create')->with('alert', 'Data Peminjaman Tidak Valid');
          }else if($json['msg'] == 'Not Available'){
            return redirect('bookings/create')->with('alert', 'Ruangan telah dipinjam beberapa saat lalu, Silahkan segarkan kembali halaman peminjaman');
          }else{
            return redirect('bookings/create')->with('alert', 'Server sedang dalam perbaikan');
          }
        }
  }
