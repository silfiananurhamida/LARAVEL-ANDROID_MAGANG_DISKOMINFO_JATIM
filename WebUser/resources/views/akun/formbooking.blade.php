...
<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
    <form class="login100-form validate-form flex-sb flex-w" method="POST" action="{{ route('bookings') }}" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <textarea onKeyPress="if(this.value.length==50) return false;" name="keperluan" class="form-control is-invalid wrap-input100 validate-input m-b-36" id="validationTextarea" placeholder="Tuliskan kepentingan Anda" required></textarea>
                </div>
            </div>
        </div>
